...
from bs.core.allocation.models import Allocation, AllocationUser
from bs.core.grant.models import Grant
from bs.core.portal.utils import (generate_allocations_chart_data,
...
def center_summary(request):
    ...
    context['total_research_outputs_count'] = ResearchOutput.objects.all(
    ).distinct().count()
