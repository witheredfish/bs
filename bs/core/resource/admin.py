...
from bs.core.resource.models import (
    AttributeType, Resource,
    ResourceAttribute, ResourceAttributeType, ResourceType)
...
class ResourceAttributeTypeAdmin(SimpleHistoryAdmin):
    list_display = ('pk', 'name', 'attribute_type_name', 'is_required',
                    'is_unique_per_resource', 'is_value_unique', 'created', 'modified', )
    search_fields = ('name', 'attribute_type__name', 'resource_type__name',)
    list_filter = ('attribute_type__name', 'name', 'is_required',
                   'is_unique_per_resource', 'is_value_unique')
...
class ResourceAdmin(SimpleHistoryAdmin):
    ...
    list_filter = ('resource_type__name', 'is_allocatable',
                   'is_available', 'is_public', 'requires_payment')
...
class ResourceAttributeAdmin(SimpleHistoryAdmin):
    list_display = ('pk', 'resource_name', 'value',
                    'resource_attribute_type_name', 'created', 'modified', )
    search_fields = ('resource__name',
                     'resource_attribute_type__name', 'value')
